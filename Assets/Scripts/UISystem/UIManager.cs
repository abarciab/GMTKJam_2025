...
public enum UIAction { PAUSE, RESUME, TOGGLE_PAUSE, FADE_TO_BLACK, FADE_FROM_BLACK, DISPLAY_HOVERED, DISPLAY_CAR_INVENTORY, UPDATE_TIMER, SHOW_DEATH_SCREEN, SHOW_BREAK_PROGRESS,
    ...
    SHOW_POPUP, SHOW_STATUS, HIDE_STATUS, SHOW_CAR_HP, OPEN_REPAIR_MENU, TOGGLE_CAR_INVENTORY, SHOW_STAMINA, FINISH_NPC_CONVERSATION, END_TRADE, OPEN_PLAYER_INVENTORY_CONFIRM, 
    OPEN_CAR_INVENTORY_CONFIRM, SPIRIT_DIE};
